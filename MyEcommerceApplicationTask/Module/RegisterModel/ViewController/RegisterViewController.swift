...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imgUser.addGestureRecognizer(imageGesture)
        ...
        EditStyle.setborder(textfields: [
            txtName, txtEmail, viewdate, txtPassword, txtConfirmPassword,
            registerbtn,
        ])
    ...
    @IBAction func BtnDoneClick(_ sender: Any) {
        ...
        user.setValue(lbldob.text ?? "", forKey: "dob")

        if let image = imgUser.image,
